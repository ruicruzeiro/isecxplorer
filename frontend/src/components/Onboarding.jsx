        ...
        <div className="consent-overlay">
          <div className="consent-sheet">
            ...
            <div className="consent-body">
              ...
              dados de movimento com o servidor do ISECxplorer. Estes dados são
              usados para calcular progresso, distância, pontuação, badges e
              análises agregadas como heatmaps. Os dados são associados apenas
              ao nome de explorador escolhido, sem recolha de nome real ou
              email.
            </div>
