...
const BADGE = {
  ...
  explorer: { cls: "bp-explorer", label: "🧭 Explorador" },
  quiz_master: { cls: "bp-quiz-master", label: "🧠 Mestre do Quiz" },
  snail: { cls: "bp-snail", label: "🐌 Lesma" },
  rookie: { cls: "bp-rookie", label: "🎒 Caloiro" },
  learner: { cls: "bp-rookie", label: "🎒 Caloiro" },
    ...
    <div className="screen" id="screen-complete">
      ...
      <div className="complete-hero">
        ...
        <div className="complete-badge-row">
          <div className={`badge-pill ${BADGE[badge]?.cls || BADGE.unranked.cls}`}>
            {BADGE[badge]?.label || BADGE.unranked.label}
          </div>
          <div className="complete-badge-meta">
            <div>{quizCorrect}/{quizTotal} quizzes</div>
            <div>{Math.round(distanceM || 0)} m</div>
          </div>
        </div>
      </div>
